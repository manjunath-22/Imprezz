...
public class TC_003_Send_invoice extends Base{
	...
	String expectedSendEmailMessage="The email was sent successfully";
	ExcelUtils excel;
	String excelPath=System.getProperty("user.dir")+"\\TestData\\TestData.xlsx";
	String sheetName="TC_003";
	...
	public void TC_001() throws InterruptedException, IOException
	{
		...
		home.getSendEmail().click();
		home.getSendEmailBtn().click();
		String actualSendEmailMessage=home.getSendEmailMessage().getText();
		Assert.assertEquals(actualSendEmailMessage,expectedSendEmailMessage);
